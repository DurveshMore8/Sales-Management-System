...
class _UpdateEmployeeState extends State<UpdateEmployee> {
  ...
  void initState() {
    super.initState();
    name.text = EmployeeState.updateEmployee['Name'];
    username.text = EmployeeState.updateEmployee['Username'];
    phone.text = EmployeeState.updateEmployee['Phone'];
    emailid.text = EmployeeState.updateEmployee['EmailId'];
    gender = EmployeeState.updateEmployee['Gender'];
    dob.text = EmployeeState.updateEmployee['DateofBirth'];
