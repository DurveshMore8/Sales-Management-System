...
class UpdateEmployeeState extends State<UpdateEmployee> {
  ...
  List<String> branches = [
    ' Select Branch                                                                                  ',
    EmployeeState.updateEmployee['BranchName']
  ];
  int age = -1;
  String gender = 'a';
  bool valid = true;
  ...
  void initState() {
    ...
    controllers[5].text =
        ' Select Branch                                                                                  ';
    getData();
    controllers[0].text = EmployeeState.updateEmployee['Name'];
    controllers[1].text = EmployeeState.updateEmployee['Username'];
    controllers[2].text = EmployeeState.updateEmployee['Phone'];
    controllers[3].text = EmployeeState.updateEmployee['EmailId'];
    gender = EmployeeState.updateEmployee['Gender'];
    controllers[4].text = EmployeeState.updateEmployee['DateofBirth'];
    age = AgeCalculator.age(DateTime.parse(controllers[4].text)).years;
    controllers[5].text = EmployeeState.updateEmployee['BranchName'];
  }
                          ...
                          onPressed: () async {
                            ...
                            if (valid) {
                              ...
                              await DB.updatedata(
                                  ...
                                  'EmailId',
                                  controllers[3].text);
                              await DB.updatedata('Username',
                                  controllers[1].text, 'Gender', gender);
                              await DB.updatedata(
                                  'Username',
                                  controllers[1].text,
                                  'DateofBirth',
